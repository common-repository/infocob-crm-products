<?php
	...
	class RightFilters implements Filters {
		...
		public function __construct(int $post_id) {
			...
			$config = get_post_meta($this->post_id, "right-filters", true);
		...
		public function get() {
			...
			$html = '
			<div class="infocob-crm-products ' . $this->post_id . ' filters right" data-post_id="' . $this->post_id . '">
