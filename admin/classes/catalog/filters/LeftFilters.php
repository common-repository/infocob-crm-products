<?php
	...
	class LeftFilters implements Filters {
		...
		public function __construct(int $post_id) {
			...
			$config = get_post_meta($this->post_id, "left-filters", true);
		...
		public function get() {
			...
			$html = '
			<div class="infocob-crm-products ' . $this->post_id . ' filters left" data-post_id="' . $this->post_id . '">
