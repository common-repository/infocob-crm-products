<?php
	...
	use Infocob\CRM\Products\Admin\Classes\Infocob\Entities\FamilleTypeInventaireProduitEntity;
	
	if(!defined('ABSPATH') && !is_admin()) {
		die();
	}
	
	class FamilleTypeInventaireProduitCore extends FamilleTypeInventaireProduitEntity {
