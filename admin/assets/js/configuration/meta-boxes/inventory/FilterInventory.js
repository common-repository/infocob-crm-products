...
export class FilterInventory {
    ...
    load(configBase64) {
        jQuery("#inventory-filters > .content-filter").html("");
        jQuery("#inventory-filters .icp-loader").addClass("active");
    ...
    render() {
        ...
        this.toHTML().then((html) => {
            ...
            jQuery("#inventory-filters .icp-loader").removeClass("active");
    ...
    save() {
        ...
        jQuery(`#${this.id} > input[name=inventory-filters]`).val(base64Json);
    }
    ...
    addFieldsEvents() {
        ...
        let selects_search = jQuery('#inventory-filters select.search');
