...
export class FilterRow extends Filter {
    ...
    toHTML() {
        return new Promise((resolve, reject) => {
            Utils.getChampsInventairesInfocob(this.module).then((fields) => {
                let options = ``;
                ...
                resolve(`
                    <div class="row-filter filter" data-id="${ this.id }">
                        ...
                        <div class="input custom">
                            <select data-name="field_name" class="search" data-tippy-content="${ _x("Field", "Admin view configuration post, meta-box 'inventory'", 'infocob-crm-products') }">
                                ${ options }
                            </select>
                        </div>
                        <div class="input custom">
                            <select data-name="operator" data-tippy-content="${ _x("Operator", "Admin view configuration post, meta-box 'inventory'", 'infocob-crm-products') }">
                        ...
                        <div class="input custom">
                            <input data-name="value" type="text" value="${ this.value }" ${(["is_null", "is_not_null"].includes(this.operator)) ? "disabled" : ""} data-tippy-content="${ _x("Value", "Admin view configuration post, meta-box 'inventory'", 'infocob-crm-products') }"/>
                        </div>
                        <div class="input">
