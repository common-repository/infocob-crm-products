...
export class FilterPostMeta {
    ...
    applyEvents() {
        ...
        let meta_key = jQuery(top_filter_element).find("input[data-name='meta-key']");
    ...
    getFilterElement() {
        return jQuery(`#top-filters .top-filters-container .filter.post-meta[data-id='${ this.id }']`).first();
    }
