...
export class FilterTaxonomy {
    ...
    toHTML() {
        return new Promise((resolve, reject) => {
            ...
            let taxonomy_html = `<select data-name="taxonomy" class="all-witdh" data-tippy-content="${ _x("Taxonomy", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }"><option value=""></option></select>`;
            if(post_type_value !== "") {
                promises.push(Utils.getTaxonomiesFromPostType(post_type_value).then((taxonomies) => {
                    ...
                    taxonomy_html = `
						<select data-name="taxonomy" class="all-witdh" data-tippy-content="${ _x("Taxonomy", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }">
							${options}
						</select>
					`;
                }));
                    ...
                    <div class="filter taxonomy" data-id="${ this.id }">
                        <div class="display margin">
                            <select data-name="display" class="all-witdh" data-tippy-content="${ _x("Display", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }">
								<option value="list" ${ (this.display === "list") ? "selected" : "" }>${ _x("List", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }</option>
    ...
    applyEvents() {
        ...
        let taxonomy = jQuery(right_filter_element).find("select[data-name='taxonomy']");
    ...
    getFilterElement() {
        return jQuery(`#right-filters .right-filters-container .filter.taxonomy[data-id='${ this.id }']`).first();
    }
