...
export class FilterAcf {
    ...
    toHTML() {
        return new Promise((resolve, reject) => {
            ...
            let acf_group_html = `<select data-name="acf-group" class="all-witdh" data-tippy-content="${ _x("Group", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }"><option value=""></option></select>`;
            if(post_type_value !== "") {
                promises.push(Utils.getAcfFieldGroupsFromPostType(post_type_value).then((acf_groups) => {
                    ...
                    acf_group_html = `
						<select data-name="acf-group" class="all-witdh" data-tippy-content="${ _x("Group", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }">
							${ options }
						</select>
					`;
                }));
            ...
            let acf_field_html = `<select data-name="acf-field" class="all-witdh" data-tippy-content="${ _x("Field", "Admin view catalog post, meta-box 'right-filters'", 'infocob-crm-products') }"><option value=""></option></select>`;
            if(this.acf_group !== "") {
    ...
    applyEvents() {
        ...
        let acf_group = jQuery(right_filter_element).find("select[data-name='acf-group']");
        ...
        jQuery(acf_group).off("change").on("change", (event) => {
            ...
            if(current_value !== previous_acf_group) {
                ...
                let acf_field = jQuery(right_filter_element).find("select[data-name='acf-field']");
    ...
    getFilterElement() {
        return jQuery(`#right-filters .right-filters-container .filter.acf[data-id='${ this.id }']`).first();
    }
