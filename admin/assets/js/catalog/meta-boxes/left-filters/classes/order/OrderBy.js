...
export class OrderBy {
                    ...
                    <div class="order-by-container" data-id="${ this.id }">
                        ...
                        <div class="main-content margin">
                            <div class="order-by margin">
                                <select data-name="order-by" class="all-witdh" data-tippy-content="${ _x("Order by", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }">
                                    <option value="ID" ${(this.order_by === "ID") ? `selected` : ``}>${ _x("ID", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="author" ${(this.order_by === "author") ? `selected` : ``}>${ _x("Author", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="title" ${(this.order_by === "title") ? `selected` : ``}>${ _x("Title", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="name" ${(this.order_by === "name") ? `selected` : ``}>${ _x("Name", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="date" ${(this.order_by === "date") ? `selected` : ``}>${ _x("Date", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="modified" ${(this.order_by === "modified") ? `selected` : ``}>${ _x("Modified", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="parent" ${(this.order_by === "parent") ? `selected` : ``}>${ _x("Parent", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="rand" ${(this.order_by === "rand") ? `selected` : ``}>${ _x("Rand", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="comment_count" ${(this.order_by === "comment_count") ? `selected` : ``}>${ _x("Comment count", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="menu_order" ${(this.order_by === "menu_order") ? `selected` : ``}>${ _x("Menu order", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="meta_value" ${(this.order_by === "meta_value") ? `selected` : ``}>${ _x("Meta value", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="meta_value_num" ${(this.order_by === "meta_value_num") ? `selected` : ``}>${ _x("Meta value num", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                </select>
                            </div>
                            <div class="order margin">
                                <select data-name="order" class="all-witdh" data-tippy-content="${ _x("Order", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }">
                                    <option value="ASC" ${(this.order === "ASC") ? `selected` : ``}>${ _x("ASC", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                    <option value="DESC" ${(this.order === "DESC") ? `selected` : ``}>${ _x("DESC", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }</option>
                                </select>
                            </div>
                            <div class="meta-key margin">
                                <input list="left-filters-order-by-${ this.id }-${ this.meta_key }" autocomplete="off" type="text" data-name="meta-key" class="all-witdh" value="${ this.meta_key }" data-tippy-content="${ _x("Meta key", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }" placeholder="${ _x("Meta key", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products') }">
                                <datalist id="left-filters-order-by-${ this.id }-${ this.meta_key }">
                                    ${ meta_key_list_html }
                                </datalist>
                            </div>
                        </div>
                        ...
                        <div class="actions-container">
                            <div class="products-order-by">
                                <button type="button" class="del-order-by">${_x("Delete", "Admin view catalog post, meta-box 'left-filters'", 'infocob-crm-products')}</button>
                            </div>
                        </div>
                    </div>
                `);
    ...
    getOrderByElement() {
        return jQuery(`#left-filters .left-filters-container .filter.order-by .content-products-order-by .order-by-container[data-id='${ this.id }']`).first();
    }
